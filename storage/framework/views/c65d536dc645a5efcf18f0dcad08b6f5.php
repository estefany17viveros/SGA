...
<?php if(file_exists(public_path('images/logo-itaf.jpg'))): ?>
  <img class="marca-agua" src="<?php echo e(asset('images/logo-itaf.jpg')); ?>" alt="">
<?php endif; ?>
...
<div class="boletin">
  ...
  <div class="cab">
    <div class="cab-logo">
      <?php if(file_exists(public_path('images/logo-itaf.jpg'))): ?>
        <img src="<?php echo e(asset('images/logo-itaf.jpg')); ?>" alt="Logo ITAF">
      <?php else: ?>
    ...
    <div class="cab-meta">
      ...
      <div class="cab-meta-fila">Año: <strong><?php echo e($yearLectivo ?? '2025'); ?></strong></div>
      <div class="cab-meta-fila">Calendario: <strong>A</strong></div>
      <div class="cab-meta-fila">Periodo: <strong><?php echo e($period->name); ?></strong></div>
      <div class="cab-meta-fila">Estado: <strong>Matriculado</strong></div>
      <div class="cab-meta-fila">Fecha: <strong><?php echo e(now()->translatedFormat('d/m/Y')); ?></strong></div>
    </div>
  </div>
  ...
  <div class="card-estudiante">
    <div>
      ...
      <div class="valor"><?php echo e(strtoupper($student->full_name)); ?></div>
    </div>
    <div>
      <div class="campo">Identificación</div>
      <div class="valor"><?php echo e($student->identification_number); ?></div>
    </div>
    <div>
      <div class="campo">Grado</div>
      <div class="valor"><?php echo e($grade); ?></div>
    </div>
  </div>
  ...
  <div class="resumen">
    <div class="resumen-item">
      ...
      <div class="r-valor"><?php echo e(round($scores->avg('total'), 2)); ?></div>
    </div>
    <div class="resumen-item">
      <div class="r-label">Ponderado</div>
      <div class="r-valor"><?php echo e(number_format($scores->avg('total'), 3)); ?></div>
    </div>
    <div class="resumen-item">
      <div class="r-label">Puesto</div>
      <div class="r-valor"><?php echo e($puesto ?? '—'); ?></div>
    </div>
    <div class="resumen-item">
      <div class="r-label">Materias</div>
      <div class="r-valor"><?php echo e($scores->count()); ?></div>
    </div>
  </div>
    ...
    <div class="materia">
      ...
      <div class="mat-header">
        <div class="mat-header-izq">
          <div class="mat-nombre"><?php echo e($subject); ?></div>
          <div class="mat-docente"><?php echo e(strtoupper($teacher)); ?></div>
          <?php if($historial->isNotEmpty()): ?>
            <div class="mat-historial">
              <?php $__currentLoopData = $historial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($h->period->name); ?>: <strong><?php echo e(number_format($h->total, 1)); ?></strong><?php if(!$loop->last): ?> &nbsp;·&nbsp; <?php endif; ?>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          <?php endif; ?>
        </div>
        <div class="mat-header-der">
          <span class="mat-badge"><?php echo e($score->nivel_nombre); ?></span>
          <div class="mat-nota"><?php echo e($score->total); ?></div>
        </div>
      </div>

      <div class="mat-dims">
        <div class="dim-chip">Saber <strong><?php echo e($score->saber); ?></strong></div>
        <div class="dim-chip">Hacer <strong><?php echo e($score->hacer); ?></strong></div>
        <div class="dim-chip">Ser <strong><?php echo e($score->ser); ?></strong></div>
        <div class="dim-chip">Total <strong><?php echo e($score->total); ?></strong></div>
      </div>

      <div class="mat-comentarios">
        <?php if($comentarios->isNotEmpty()): ?>
          <div class="com-titulo">Observaciones — <?php echo e($score->nivel_nombre); ?></div>
          <?php $__currentLoopData = ['saber', 'hacer', 'ser']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(isset($comentarios[$dim]) && $comentarios[$dim]->comment): ?>
              <div class="com-fila">
                <span class="com-prefijo"><?php echo e($prefijo); ?>,</span>
...
<a href="<?php echo e(route('teacher.boletin.pdf', [$student->id, $period->id])); ?>"
   style="background:#1e3a8a;color:white;padding:6px 12px;text-decoration:none;">
   Descargar PDF
</a>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SGA\resources\views/boletin/show.blade.php ENDPATH**/ ?>