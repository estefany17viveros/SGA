...
<div class="relative">
    ...
    <div id="menu1" class="hidden absolute bg-white text-black mt-2 rounded shadow-lg w-48 z-50">
        <a href="<?php echo e(route('admin.teachers.index')); ?>" class="block px-4 py-2 hover:bg-gray-200">
            Lista de profesores
        </a>

        <a href="<?php echo e(route('admin.teacher-subjects.index')); ?>" class="block px-4 py-2 hover:bg-gray-200">
...
<div class="relative">
    ...
    <div id="menu2" class="hidden absolute bg-white text-black mt-2 rounded shadow-lg w-48 z-50">
        ...
        <a href="<?php echo e(route('admin.academic_years.index')); ?>" class="block px-4 py-2 hover:bg-gray-200">
            Años académicos
        </a>

        <a href="<?php echo e(route('admin.grades.index')); ?>" class="block px-4 py-2 hover:bg-gray-200">
            Grados
        </a>
...
<div class="relative">
    ...
    <div id="menu3" class="hidden absolute bg-white text-black mt-2 rounded shadow-lg w-56 z-50">
        ...
        <a href="<?php echo e(route('admin.students.index')); ?>" class="block px-4 py-2 hover:bg-gray-200">
            Estudiantes
        </a>
...
<div class="relative">
    ...
    <div id="menu6" class="hidden absolute bg-white text-black mt-2 rounded shadow-lg w-56 z-50">
        ...
        <a href="<?php echo e(route('admin.boletin.index')); ?>" 
