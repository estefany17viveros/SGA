          ...
          <td class="dim-td">
            <table class="dim-inner"><tr>
              ...
              <td class="dim-lbl-td">
                ...
                <span class="dim-nt"><?php echo e(number_format($score->saber, 2)); ?></span>
              </td>
            </tr></table>
          </td>
          <td class="dim-td">
            <table class="dim-inner"><tr>
              ...
              <td class="dim-lbl-td">
                ...
                <span class="dim-nt"><?php echo e(number_format($score->hacer, 2)); ?></span>
              </td>
            </tr></table>
          </td>
          <td class="dim-td">
            <table class="dim-inner"><tr>
              ...
              <td class="dim-lbl-td">
                ...
                <span class="dim-nt"><?php echo e(number_format($score->ser, 2)); ?></span>
              </td>
            </tr></table>
          </td>
        </tr>
