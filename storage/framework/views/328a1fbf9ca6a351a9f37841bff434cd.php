...
/* ── BOTÓN PDF (solo vista web) ── */
.btn-pdf-wrap { text-align: center; padding: 12px 0; }
.btn-pdf { display: inline-block; background: #1a3a6b; color: #fff; font-size: 9px; font-weight: 700; padding: 5px 14px; border-radius: 4px; text-decoration: none; }

@page { size: A4; margin: 0; }
@media print {
    * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
    .mat-card { page-break-inside: avoid; }
    .btn-pdf-wrap { display: none; }
}
</style>

<?php echo $__env->make('admin.boletin.boletin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php if(!isset($isPdf)): ?>
<div class="btn-pdf-wrap">
    <a class="btn-pdf" href="<?php echo e(route('admin.boletin.pdf', [$student->id, $period->id])); ?>">
        ⬇ Descargar PDF
    </a>
</div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.print', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SGA\resources\views/admin/boletin/show.blade.php ENDPATH**/ ?>