<nav class="bg-gradient-to-r from-colegioAzul to-colegioVerde shadow-xl px-8 py-5 rounded-b-3xl">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center space-x-6">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="text-white font-bold text-lg">
                🌿 SGA
            </a>

            <a href="<?php echo e(route('dashboard')); ?>" class="text-white hover:underline">
                Inicio
            </a>

            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->role === 'admin'): ?>
                    <?php echo $__env->make('layouts.menus.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>

                <?php if(Auth::user()->role === 'teacher'): ?>
                    <?php echo $__env->make('layouts.menus.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.menus.script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SGA\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>