...
<?php echo app('Illuminate\Foundation\Vite')('resources/css/admin/subjects/index.css'); ?>
<?php $__env->stopPush(); ?>
...
<div class="subjects-index-page">
    ...
    <a href="<?php echo e(route('admin.subjects.create')); ?>" class="btn-create">
        Crear nueva materia
    </a>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('admin.subjects.show', $subject)); ?>" class="btn-view">Ver</a>
                        <a href="<?php echo e(route('admin.subjects.edit', $subject)); ?>" class="btn-edit">Editar</a>
