{{--
    ...
    Sin @extends ni @section — se puede incluir con @include desde cualquier vista.
    Variables esperadas:
        $student, $scores, $allScores, $puesto, $grade,
        $period, $yearLectivo, $logoBase64, $isPdf (opcional)
--}}
@php
                        ...
                        @if($historial->isNotEmpty())
                            <div style="margin-top:3px;">
                                @foreach($historial as $h)
                                    <span class="hist-pill">{{ $h->period->name }}: {{ number_format(floor($h->total * 100) / 100, 2, '.', '') }}</span>
                                @endforeach
                            </div>
                        @endif
                    </td>
                    ...
                    <td class="dim-td">
                        <table class="dim-inner"><tr>
                            ...
                            <td class="dim-lbl-td">
                                ...
                                <span class="dim-nt">{{ number_format($saber, 2) }}</span>
                            </td>
                        </tr></table>
                    </td>
                    <td class="dim-td">
                        <table class="dim-inner"><tr>
                            ...
                            <td class="dim-lbl-td">
                                ...
                                <span class="dim-nt">{{ number_format($hacer, 2) }}</span>
                            </td>
                        </tr></table>
                    </td>
                    <td class="dim-td">
                        <table class="dim-inner"><tr>
                            ...
                            <td class="dim-lbl-td">
                                ...
                                <span class="dim-nt">{{ number_format($ser, 2) }}</span>
                            </td>
                        </tr></table>
                    </td>
                </tr>
